...
- Public version **1.0, build 42** was submitted on **21 September 2026 at 08:34 UTC** in submission `6b5a1281-f265-46dc-ac15-0cb74da89b5a`. The API read-back is **Waiting for Review**, with all 21 items: the app, ten subscription versions and ten subscription-group versions. A verified physical-iPhone sandbox recording is attached; see [the recording evidence](Store/PHYSICAL-REVIEW-RECORDING.md). Approval is pending.
