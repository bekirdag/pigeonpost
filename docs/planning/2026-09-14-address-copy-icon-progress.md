...
- Android 0.2.4/code 7 is signed and available on internal testing. Production promotion is saved at 100% of all targeted countries; app and icon changes await public submission. The Playwright transport disconnected before the final submission, and a reconnection request is pending.
